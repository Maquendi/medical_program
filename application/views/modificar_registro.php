...
<?php echo form_open_multipart("Controlador/modify_user"); ?>  
...
<div class="col-md-2">
   ...
   <div class="jumbotron">
    ...
    <div class="row">
      <div class="col-sm-6">
       <legend><h3 style="color:green; font-family:serif;">Modificar Registro Usuario</h3>
       </legend>
      </div>
          ...
          $.ajax({
            ...
            data:{cedula:ced},
             success:function(result){
               ...
               if(result !== "false")
               {
                  replaceDatos(JSON.parse(result));
               }else
               {
                 document.getElementById('mensaje').innerHTML = "Cedula No Registrado.";
               }
            }
          })
